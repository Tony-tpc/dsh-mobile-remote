...
.collapsebtn{align-self:stretch;text-align:center;font-size:12px;font-weight:700;color:#9fc2e8;background:#15202d;border:1px solid #3b82f6;border-radius:10px;padding:8px 12px;cursor:pointer;margin:2px 0}
.collapsebtn:active{background:#1b2a3d}
